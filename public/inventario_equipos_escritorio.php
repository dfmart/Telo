...
if (isset($_POST["ins"])) {
    ...
    $sql = "INSERT INTO registro_escritorio (placa, serial, proveedor, marca, modelo, procesador, tipmemoria, tammemoria,nummodulo, tipdisco,tamano, bateria, nota, estado, cliente, tecnico, fecha_ingreso, fecha_salida) 
