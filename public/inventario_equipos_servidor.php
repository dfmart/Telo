...
if (isset($_POST["ins"])) {
    ...
    $sql = "INSERT INTO registro_servidor (placa, serial, proveedor, marca, modelo, procesador, tipmemoria, tammemoria, nummodulo, tipdisco,tamano, nota, estado, cliente, tecnico, fecha_ingreso, fecha_salida) 
            VALUES (:pla, :ser, :pro, :mar, :mod, :proc, :tipmem, :tammem, :nummod, :tipdis, :tam, :not, :est, :cli, :tec, :fecing, :fecsal)";
    ...
    header("Location: inventario_equipos_servidor.php");
    exit();
}
